                                ...
                                <InfoCard key={`fututama-${title}-${infoData.id}`}>
                                    ...
                                    <Synopsis>
                                        ...
                                        <p className={isOn ? 'show-Txt' : 'hide-Txt'}>
                                            1999년 12월 31일 막장 생활을 달리고 있는 멍청한 피자
                                            배달부 필립 J. 프라이가 냉동보존 실험실에서 장난전화로
                                            시킨 피자를 먹다가 그 벌로 냉동캡슐로 들어가 천 년 동안
                                            냉동인간이 되어버린다. 천 년 뒤에 깨어나 보니, 세상은
                                            자기보다 더 막장을 달리고 있는 것이 아닌가? 프라이는
                                            가족, 친구, 자기가 아는 사람이 아무도 없다는 걸 알고
                                            환호성을 지른다. 그러다가 릴라라는 외눈박이 외계인(으로
                                            알려졌으나, 사실 지하에 사는 돌연변이의 자손이다)을 만난
                                            프라이는 영웅적인 행보를 보이며 자신에게 직업칩을
                                            박으려는 릴라를 냉동캡슐에 집어넣고, 알코올로 움직이며
                                            자기보다 더 막장의 극치를 달리는 로봇인 벤더와 마주치게
                                            된다. 프라이는 벤더와 함께 도망쳐 다니다가, 프라이가 한
                                            일을 복수하러 온 릴라를 자기 편, 즉 막장화 시켜버리게
                                            된다. 직장을 잃은 그들은 일자리를 얻으려고 프라이와 제일
                                            가까운 친척인 휴버트 J. 판스워드 박사를 공갈·협박해,
                                            판스워스 교수가 소유한 운송회사인 "플래닛 익스프레스"에
                                            취직하게 된다. 그리고 그들은 랍스터와, 인턴 나온 부잣집
                                            딸, 그리고 관료주의 회계사와 함께 회사를 꾸려가면서
                                            우주와 인류를 구원(이라 적고 박살이라고 읽는다)하거나,
                                            위험한 행성(예를 들어 위뷁-7행성에 백괴사전글과 그림을
